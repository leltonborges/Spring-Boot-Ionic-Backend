...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("com.dev.course.resources")).paths(PathSelectors.any())
				.build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot", "Esta API é utilizada no curso de Spring Boot por Lelton Borges",
				"Versão 1.0", "https://www.google.com/", new Contact("Lelton Borges", "#", "lelton.borges1@gmail.com"),
				"Permitido uso para estudantes", "https://www.google.com/", Collections.emptyList());
	}
